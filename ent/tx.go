...
func (tx *Tx) init() {
	...
	tx.Dictionary_Item = NewDictionaryItemClient(tx.config)
	tx.Menu = NewMenuClient(tx.config)
	tx.Organization = NewOrganizationClient(tx.config)
	tx.Position = NewPositionClient(tx.config)
	tx.Role = NewRoleClient(tx.config)
	tx.Role_Menu = NewRoleMenuClient(tx.config)
	tx.Role_Organization = NewRoleOrganizationClient(tx.config)
	tx.Staff = NewStaffClient(tx.config)
	tx.Staff_Position = NewStaffPositionClient(tx.config)
	tx.Staff_Role = NewStaffRoleClient(tx.config)
}
