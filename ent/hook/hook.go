...
// The Dictionary_ItemFunc type is an adapter to allow the use of ordinary
// function as Dictionary_Item mutator.
type Dictionary_ItemFunc func(context.Context, *ent.DictionaryItemMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f Dictionary_ItemFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.DictionaryItemMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.DictionaryItemMutation", m)
}
...
// The Role_MenuFunc type is an adapter to allow the use of ordinary
// function as Role_Menu mutator.
type Role_MenuFunc func(context.Context, *ent.RoleMenuMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f Role_MenuFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
...
// The Role_OrganizationFunc type is an adapter to allow the use of ordinary
// function as Role_Organization mutator.
type Role_OrganizationFunc func(context.Context, *ent.RoleOrganizationMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f Role_OrganizationFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.RoleOrganizationMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.RoleOrganizationMutation", m)
}
...
// The Staff_PositionFunc type is an adapter to allow the use of ordinary
// function as Staff_Position mutator.
type Staff_PositionFunc func(context.Context, *ent.StaffPositionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f Staff_PositionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.StaffPositionMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.StaffPositionMutation", m)
}

// The Staff_RoleFunc type is an adapter to allow the use of ordinary
// function as Staff_Role mutator.
type Staff_RoleFunc func(context.Context, *ent.StaffRoleMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f Staff_RoleFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
