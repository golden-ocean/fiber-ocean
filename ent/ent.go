...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			dictionary_item.Table:   dictionary_item.ValidColumn,
			menu.Table:              menu.ValidColumn,
			organization.Table:      organization.ValidColumn,
			position.Table:          position.ValidColumn,
			role.Table:              role.ValidColumn,
			role_menu.Table:         role_menu.ValidColumn,
			role_organization.Table: role_organization.ValidColumn,
			staff.Table:             staff.ValidColumn,
			staff_position.Table:    staff_position.ValidColumn,
			staff_role.Table:        staff_role.ValidColumn,
		})
	})
