...
// 	"github.com/golden-ocean/fiber-ocean/pkg/middlewares/pasetoware"
...
// 	t, err := pasetoware.CreateToken([]byte(secret), id, time.Minute*time.Duration(minutesCount), pasetoware.PurposeLocal)
// 	return t, err
// }
